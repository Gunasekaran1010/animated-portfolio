...
function Contact() {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_ukxx3lg', 'template_217wa1n', formRef.current, 'B16vXul3n7lh9PVEl')
      .then(
        () => {
          setSuccess(true);
          setError(false);
    ...
    <motion.div className="contact" ref={ref} variants={variants} initial="initial" whileInView="animate">
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <h2>Mail</h2>
          <span>gunasekaran4031@gmail.com</span>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <h2>Address</h2>
      ...
      <div className="formContainer">
        ...
        >
          ...
          {error && <span className="error">There was an error, please try again.</span>}
          {success && <span className="success">Your message was sent successfully!</span>}
        </motion.form>
      </div>
    </motion.div>
  );
